(ns clojure4j.explorer.questions.$71to80.#78-core-functions-m-reimplement-trampoline)
...
(println (fn [] (+ 1 3)))
;; => #object[clojure4j.explorer.questions.$71to80._SHARP_78_core_functions_m_reimplement_trampoline$eval211$fn__212 0x4426bff1 clojure4j.explorer.questions.$71to80._SHARP_78_core_functions_m_reimplement_trampoline$eval211$fn__212@4426bff1]
(println ((fn [] (+ 1 3))))
;; => 4
