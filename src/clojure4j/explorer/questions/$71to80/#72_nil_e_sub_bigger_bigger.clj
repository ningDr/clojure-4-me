(ns clojure4j.explorer.questions.$71to80.#72-nil-e-sub-bigger-bigger)
(defn sub-bigger-bigger
  "
  ...
  "
  [arg]
  (println (= (arg (map inc (take 3 (drop 2 [2 5 4 1 3 6])))) (->> [2 5 4 1 3 6] (drop 2) (take 3) (map inc) (arg)) 11))
  )

(sub-bigger-bigger #(apply + %))
(println (apply + [1 2 3]))